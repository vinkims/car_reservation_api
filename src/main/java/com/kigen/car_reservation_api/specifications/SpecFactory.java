...
public class SpecFactory {
    ...
    public SpecBuilder<?> generateSpecification(String searchQuery, SpecBuilder<?> specBuilder, List<String> allowableFields) {

        searchQuery = searchQuery != null ? searchQuery : "";
        String[] searchQueries = searchQuery.split(",");
        String patternStr = "^(?<key>\\w+(?<key1>\\.\\w+)*)(?<op>EQ|GT|LT|NEQ)(?<value>(?<value1>\\w+)(?<value2>-\\w+)*)$";
