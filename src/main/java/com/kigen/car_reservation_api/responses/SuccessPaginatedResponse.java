package com.kigen.car_reservation_api.responses;
...
import com.kigen.car_reservation_api.dtos.general.PageInfoDTO;
...
public class SuccessPaginatedResponse {
    ...
    public SuccessPaginatedResponse(
            ...
            List<?> dataArray, 
            Class<?> customClass, 
            Class<?> entityClass) throws InstantiationException, IllegalAccessException, 
